          ...
          <form onSubmit={handleSavePost} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input 
                ...
                required
                className="bg-secondary border-border focus:border-primary transition-colors text-xl"
            ...
            <div className="space-y-2">
              <label className="text-sm text-muted-foreground">Content (Markdown supported)</label>
              <Textarea 
                value={formData.content}
                onChange={(e) => setFormData({...formData, content: e.target.value})}
                required
                rows={20}
                className="bg-secondary border-border focus:border-primary transition-colors resize-none font-mono text-sm"
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Create, edit, and delete your blog posts</p>
          </div>
          <Button 
        ...
        <div className="space-y-4">
          {blogs.length === 0 ? (
            ...
            blogs.map((blog) => (
              <Card key={blog.id} className="p-6 bg-card border-border hover:border-primary/50 transition-colors">
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button 
                      ...
                      variant="outline" 
                      size="sm"
                      className="border-border hover:bg-secondary hover:text-red-500 transition-colors"
                    >
